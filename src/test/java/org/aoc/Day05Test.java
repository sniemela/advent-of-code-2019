...
public class Day05Test {
    ...
    public void testPart2() {
        long[] code = new long[] { 3, 21, 1008, 21, 8, 20, 1005, 20, 22, 107, 8, 21, 20, 1006, 20, 31, 1106, 0, 36, 98, 0,
                ...
                98, 99 };
        assertEquals(999, Day05.interp(7, Arrays.copyOf(code, code.length)));
        assertEquals(1000, Day05.interp(8, Arrays.copyOf(code, code.length)));
        assertEquals(1001, Day05.interp(9, Arrays.copyOf(code, code.length)));
    }
}
